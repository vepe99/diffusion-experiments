...
if __name__ == "__main__":
    ...
    workflow = load_model(adapter=adapter, conf_tuple=conf_tuple, param_names=param_names, training_data=training_data,
                              validation_data=validation_data, storage=BASE / "models", problem_name=problem_name,
    ...
    if os.path.exists(BASE / "metrics" / f'{problem_name}_metrics_{model_name}.pkl'):
        with open(BASE / "metrics" / f'{problem_name}_metrics_{model_name}.pkl', 'rb') as f:
        ...
        with open(BASE / "metrics" / f'{problem_name}_metrics_{model_name}.pkl', 'wb') as f:
