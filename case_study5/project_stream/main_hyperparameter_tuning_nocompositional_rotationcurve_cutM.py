...
if __name__ == "__main__":
    ...
    remove_lowmass_mask = (training_data['m_Triaxial_halo'] > 5e11).flatten()
    ...
    #     print(f"Training data key: {k}, shape: {training_data[k].shape}")
    training_data = {k: training_data[k][remove_lowmass_mask] for k in training_data.keys()}
    ...
    remove_lowmass_mask_multistream = (test_data_multistream['m_Triaxial_halo'] > 5e11).flatten()
    test_data_multistream = {k: test_data_multistream[k][remove_lowmass_mask_multistream] for k in training_data.keys()}
    ...
    storage_path = "./data/hyperparameter_tuning/gala/rotationcurve_cutM/"
