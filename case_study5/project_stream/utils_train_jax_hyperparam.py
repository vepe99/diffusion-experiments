...
class AugmentationsClass:
    ...
    def observational_window(self, batch, key):
        """
    ...
    def subsampling_to_observed_n_stars(self, batch, key):
    ...
    def sample_magnitudes(self, batch, key):
        """
    ...
    def _sample_magnitudes_jit(self, j, n_particles, key):
        ...
        """
        # print('j shape:', j.shape )c
        j_flat = j.astype(jnp.int32).reshape(-1)
    ...
    def sample_obs_error(self, batch, key):
        subkey = self._split_key()
    ...
    def apply_obs_error(self, batch, key):
