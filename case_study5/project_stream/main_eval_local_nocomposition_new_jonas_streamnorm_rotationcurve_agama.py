...
@hydra.main(version_base=None, config_path="config", config_name="eval_config_local_new_rotationcurve_agama",)
def main(cfg: EvalConfig):
    ...
    clean_data = {key: test_data[key][valid_mask] for key in param_names_global + param_names_local + [inference_conditions] + ["vcirc_kms"]}
