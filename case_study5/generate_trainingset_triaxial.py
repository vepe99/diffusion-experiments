...
from stream_simulator_odisseo_triaxial import sample_hierarchical_stream_priors, simulate_stream
...
np.savez('./case_study5/training_set_odisseo_triaxial.npz', 
         sim_data=sim_data,
         **prior_samples_arrays)
...
data = np.load('./case_study5/training_set_odisseo_triaxial.npz', allow_pickle=True)
