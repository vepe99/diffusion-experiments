...
training_data = dict(np.load('./case_study5/training_set_odisseo_triaxial.npz', allow_pickle=True))
...
model_path = BASE / 'models' / 'partial_pooling_global_triaxial.keras'
...
test_data_npz['q2'] = (test_data_npz['q2']  - training_data_raw['mean_q2'])/ training_data_raw['std_q2']
...
test_data['q1'] = (test_data_npz['q1'] *training_data_raw['std_q1'] + training_data_raw['mean_q1']) 
test_data['q2'] = (test_data_npz['q2'] *training_data_raw['std_q2'] + training_data_raw['mean_q2'])
...
fig.savefig(BASE / "plots" / "partial_pooling_global_recovery_triaxial.png")
plt.show()
...
fig = g
fig.savefig(BASE / "plots" / f"partial_pooling_global_corner_datasetid_{dataset_id}_triaxial.png")
plt.show()
...
fig.savefig(BASE / "plots" / "partial_pooling_global_calibration_triaxial.png")
plt.show()
...
f.savefig(BASE / "plots" / "partial_pooling_global_calibration_histogram_triaxial.png")
plt.show()
...
fig.savefig(BASE / "plots" / "partial_pooling_local_recovery_triaxial.png")
plt.show()
...
fig.savefig(BASE / "plots" / "partial_pooling_local_calibration_triaxial.png")
plt.show()
